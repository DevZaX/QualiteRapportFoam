          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="container"> 
                	<form action="../../zone40f/update" method="post">
                	...
                	<table>
                		<thead>
                			...
                			<th>id_mgz</th>
                			<th>emplacement</th>
                			<th><button type="submit" class="btn btn-success"><i class="fa fa-pencil"></i></button></th>
                			<th><a class="btn btn-success" href="../../zone40f/0/show"><i class="fa fa-arrow-left"></i></a></th>
                		</thead>
                		<tbody>
                			<tr>
                				<input type="hidden" name="id" value="${z.getId() }">
                				<td class="tableTD"><input type="text" name="id_alert" required="required" placeholder="numero d'alert" value="<c:out value='${z.getAlert()}'></c:out>" readonly="readonly"></td>
                				<td class="tableTD"><input type="number" name="qte" required="required" placeholder="quantite" value="<c:out value='${z.getQte()}'></c:out>"></td>
                				<td class="tableTD"><input type="text" name="id_mgz" required="required" placeholder="id_mgz" value="<c:out value='${z.getId_mgz()}'></c:out>"></td>
                				<td class="tableTD"><input type="text" name="emplacement" required="required" placeholder="emplacement" value="<c:out value='${z.getEmplacement()}'></c:out>"></td>
                			</tr>
                		</tbody>
                	</table>
                	</form>
