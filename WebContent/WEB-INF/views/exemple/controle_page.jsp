...
<html lang="en">
  ...
  <body onload="activer()">
     	...
     	<div class="col-md-4 col-md-offset-4">
     		...
     		<form action='../getControlInjectionByRefAndDate' method="post">
     		...
     		<div class="col-md-12">
     			<table class="table">
     				...
     				<tr>
	     				...
	     				<td>
	     				  <form action="../controle_injection/store" methode="POST">
	     				...
	     				<td>
	     				    <form action="../controle_injection/store" method="POST">
	     				    <input name="code" type="hidden" value="${e.getCode() }">
	     				    <input name="title" type="hidden" value="${e.getTitle() }">
